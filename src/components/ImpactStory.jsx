...
export default function ImpactStory() {
  return (
    <section style={{ display: 'flex', flexDirection: 'column' }}>
      {/* Before Sanitation */}
      <div style={{ position: 'relative', minHeight: '80vh', padding: '6rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#1a1a1a', color: 'var(--white)' }}>
        <Image 
        ...
        >
          <span style={{ color: 'var(--accent-green)', fontSize: '1.125rem', letterSpacing: '2px', textTransform: 'uppercase', fontWeight: 'bold' }}>The Challenge</span>
